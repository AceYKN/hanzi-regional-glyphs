  ...
  return (
    <main className="about-page">
      ...
      <article>
        ...
        <p>例如输入“见”，大陆显示“见”，台湾、香港和日本显示“見”；输入“東”，大陆、新加坡和马来西亚显示“东”，台湾、香港和日本显示“東”。每个结果随后再使用对应地区的 Source Han / Noto CJK 字体配置渲染。</p>
        <h2>地区范围</h2>
        <p>首版提供大陆、台湾、香港、日本、新加坡和马来西亚。新加坡与马来西亚采用简体中文 CN 写法与字形配置，并明确标注“与大陆一致”。</p>
        <h2>资料与许可</h2>
